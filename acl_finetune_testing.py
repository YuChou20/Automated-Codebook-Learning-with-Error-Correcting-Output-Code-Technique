...
parser.add_argument('-weight_name', default='(CE)acl_best_checkpoint_1.pth.tar',
...
if __name__ == '__main__':
  ...
  # training & testing
  logging.basicConfig(filename=os.path.join('./runs/{0}'.format(args.folder_name), '({0})acl_{1}.log'.format(args.loss_type,args.attack_type)), level=logging.DEBUG)
