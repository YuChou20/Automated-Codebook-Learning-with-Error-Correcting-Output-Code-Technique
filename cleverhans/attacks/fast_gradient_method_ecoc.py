...
def fast_gradient_method(
    ...
    # Compute loss
    logit = calculate_cosine_similarity(model_fn(x), codewords)
    loss = loss_fn(logit, y.detach())
    # loss = loss_fn(model_fn(x), y.detach()) # for BCE loss for attacking single ECOC members (binany models)
